  ...
  return (
    <ScrollView>
      <View style={styles.freeStyleContainer}>
        <Text style={styles.title}>Process Analysis</Text>
        <Text style={styles.question}>Q.1: Analyze the following Process.</Text>
        
         <Image
          source={require('../../../assets/images/process.jpeg')}// Replace with your image URL or local path
          style={styles.image}
