  ...
  return (
    <ScrollView>
      <View style={styles.freeStyleContainer}>
        <Text style={styles.title}>Maps Analysis</Text>
        <Text style={styles.question}>Q.1: Analyze the following Map.</Text>
        
         <Image
          source={require('../../../assets/images/map.jpeg')}// Replace with your image URL or local path
          style={styles.image}
