  ...
  return (
    <ScrollView>
      <View style={styles.freeStyleContainer}>
        <Text style={styles.title}>PIE Chart Analysis</Text>
        <Text style={styles.question}>Q.1: Analyze the following Pie chart.</Text>
        
         <Image
          source={require('../../../assets/images/piechart.png')}// Replace with your image URL or local path
          style={styles.image}
