  ...
  return (
    <ScrollView>
      <View style={styles.freeStyleContainer}>
        <Text style={styles.title}>Line Chart Analysis</Text>
        <Text style={styles.question}>Q.1: Analyze the following Line chart.</Text>
        
         <Image
          source={require('../../../assets/images/linechart.jpeg')}// Replace with your image URL or local path
          style={styles.image}
