  ...
  return (
    <ScrollView>
      <View style={styles.freeStyleContainer}>
        <Text style={styles.title}>Life Cycle Analysis</Text>
        <Text style={styles.question}>Q.1: Analyze the following Life Cycle.</Text>
        
         <Image
          source={require('../../../assets/images/lifecycle.jpeg')}// Replace with your image URL or local path
          style={styles.image}
